...
from constants import (
    ...
    RETRO_DARK, RETRO_LIGHT, RETRO_PINK, RETRO_GREEN, RETRO_ORANGE,
    RETRO_BLUE, RETRO_DARKER, RETRO_HEADER, RETRO_CARD, RETRO_BORDER,
    RETRO_WHITE, RETRO_GOLD, RETRO_DARK_GOLD, RETRO_GRAY,
    RETRO_DARK_GRAY
)
